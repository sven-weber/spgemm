...
namespace mults {
    ...
    Baseline::Baseline(int rank, int n_nodes, partition::Partitions partitions,
        ...
        std::string path_B, std::vector<size_t>* keep_cols) : CSRMatrixMultiplication(rank, n_nodes, partitions, path_A, keep_rows, path_B, keep_cols) {}

    void Baseline::gemm(std::vector<size_t> serialized_sizes_B_bytes, size_t max_size_B_bytes) {
